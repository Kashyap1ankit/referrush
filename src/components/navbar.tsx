...
export default function Navbar() {
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 flex justify-between items-center border border-zinc-800 shadow-md bg-black/30  p-2 rounded-lg w-full md:w-1/2">
